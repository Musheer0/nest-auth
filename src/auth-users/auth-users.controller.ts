...
export class AuthUsersController {
  ...
  @Post('/sign-up/email')
  async SignUpUser(
    @Body() data: SignUpEmailDto,
    @GetUserMetaData() metadata: UserMetaData,
  ) {
    try {
  ...
  @UseGuards(PublicOnlyGuard)
  @Post('/sign-in/email')
  async CredentialsSigin(
    @Body() data: CredentialsSignInDto,
    @GetUserMetaData() metadata: UserMetaData,
  ) {
    try {
  ...
  async BasicEdit(
    @Request() req,
    @GetUserMetaData() metadata: UserMetaData,
    @Body() data: EditUserBasicInfoDto,
  ) {
    try {
      const session: UserSessionToken = req['user'];
  ...
  @UseGuards(JWTGuard, UserThrottlerGuard)
  @Patch('/edit/password')
  async ResetPasswordAutorized(
    @Request() req,
    @GetUserMetaData() metadata: UserMetaData,
    @Body() data: EditUserPasswordDto,
  ) {
    try {
      const session: UserSessionToken = req['user'];
  ...
  async ResetUnAuthorizedPasswordAutorized(
    @Request() req,
    @GetUserMetaData() metadata: UserMetaData,
    @Body() data: EditUserPasswordDto,
  ) {
